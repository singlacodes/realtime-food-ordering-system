    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
                ...
                {/* WRAPPED IN FORM TAG FOR VALIDATION & ENTER KEY SUPPORT */}
                <form onSubmit={handleSignUp}>
                    ...
                    <button 
                        type="submit" 
                        className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer ${loading ? 'opacity-70 cursor-not-allowed' : ''}`} 
                        disabled={loading}
                    >
